...
az vm create --resource-group Arch-Linux --name arch_vm --os-disk-name arch_root --attach-data-disks arch_www --image Debian:debian-10:10:latest --size Standard_B1s --admin-username christian --admin-password Athaerland250877 --authentication-type all --computer-name arch --location westeurope --nsg-rule NONE --public-ip-sku Basic --public-ip-address-allocation static 
